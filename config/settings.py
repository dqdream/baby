...
NAME_DICTS["chuci"] = os.path.abspath(os.path.join(ROOT_PATH, "./dicts/json/chuci.json"))
NAME_DICTS["cifu"] = os.path.abspath(os.path.join(ROOT_PATH, "./dicts/json/cifu.json"))
NAME_DICTS["gushi"] = os.path.abspath(os.path.join(ROOT_PATH, "./dicts/json/gushi.json"))
NAME_DICTS["shijing"] = os.path.abspath(os.path.join(ROOT_PATH, "./dicts/json/shijing.json"))
NAME_DICTS["songci"] = os.path.abspath(os.path.join(ROOT_PATH, "./dicts/json/songci.json"))
NAME_DICTS["tangshi"] = os.path.abspath(os.path.join(ROOT_PATH, "./dicts/json/tangshi.json"))
NAME_DICTS["yuefu"] = os.path.abspath(os.path.join(ROOT_PATH, "./dicts/json/yuefu.json"))
